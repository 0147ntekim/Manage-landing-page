...
const Home = () => {
    return ( 
        <div className="min-w-[100%] max-[720px]:min-h-[50vh] min-h-[70vh]  flex flex-col-reverse md:flex-row justify-between mt-[70px]">
            <div className="w-[100%] md:w-[35%] max-[379px]:min-h-[60vh] max-[769px]:min-h-[50vh] min-[720px]:min-h-[20vh]  min-h-[40vh] md:min-h-[60vh] flex flex-col items-center md:items-start justify-between mt-[50px]">
